<?php
// administrador/gym/secciones/comentarios/plantilla_comentario.php
// Variables heredadas: $data_nombre, $data_mensaje
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Respuesta a tu Mensaje - Sandy's Gym</title>
    <style>
        ...
        .footer a { color: #31708f; text-decoration: none; font-weight: 600; }
    </style>
</head>
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="text-align: center; margin-top: 30px;">
                    <strong>Atentamente,</strong><br>El equipo de soporte de Sandy's Gym
                </p>
            </div>
