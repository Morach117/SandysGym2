...
// [!] CRÍTICO: Forzar utf8mb4 para extraer Emojis correctamente al buffer de PHP
...
// JSON_UNESCAPED_UNICODE mantendrá la integridad del Emoji al pasarlo a JavaScript
...
// Se añaden las clases text-left y text-center a los td para forzar la alineación
            $datos .= "<tr>
                        <td class='text-center'>$i</td>
                        <td class='text-left'>{$fila['nombres_completos']}</td>
                        <td class='text-center'>{$meses_nombres[(int)$fila['mes_nacimiento']]}</td>
                        <td class='text-center'>{$fila['soc_tel_cel']}</td>
                        <td class='text-left'>$correo_badge</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <a href="?s=plantillas" class="btn btn-default btn-sm" title="Gestionar Plantillas"><span
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="procesarEnvioIndividual()"><span
                        class="glyphicon glyphicon-send"></span> Enviar</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title text-white"><span class="glyphicon glyphicon-send"></span> Envío Masivo del Mes
                </h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-warning">
                    <span class="glyphicon glyphicon-info-sign"></span> Se enviará un correo personalizado a cada socio
                    con email registrado.
                </div>
                <div class="form-group">
                    <label>Seleccionar Plantilla Base:</label>
                    <select class="form-control input-sm select_plantilla" id="select_plantilla_masiva"
                        onchange="cargarPlantilla('masivo')">
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btnConfirmaMasivo" onclick="procesarEnvioMasivo()"
                    disabled>
