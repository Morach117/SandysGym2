...
$totales = [
    ...
    'mercado_pago'      => 0.0, // <-- NUEVO: Ingreso digital SDK v3
    'ingreso_real'      => 0.0, // Suma de todo el dinero nuevo (Efectivo + Tarjeta + Mercado Pago)
...
foreach ($ingresos_del_dia as $ingreso) {
    ...
    // Suma del dinero digital por pasarela
    $totales['mercado_pago']     += $ingreso['mercado_pago'] ?? 0;
...
$totales['ingreso_real']  = $totales['efectivo'] + $totales['tarjeta_total'] + $totales['mercado_pago'];
...
// === AJUSTE LÓGICO DE ARQUITECTURA ===
// El pendiente de retirar se calcula EXCLUYENDO Mercado Pago, ya que ese dinero entra directo a banco, no al cajón físico.
$por_retirar = ($totales['efectivo'] + $totales['tarjeta_total']) - $importe_cortes;
...
<div class="row">
        ...
        <table class="table table-condensed table-hover h6">
            <thead>
                <tr class="active">
                    ...
                    <th class="text-right text-info">Mercado Pago</th>
            ...
            <tbody>
                <tr>
                    <td>Mensualidades</td>
                    <td class="text-right text-muted"><?= '$' . number_format($ingresos_del_dia['mensualidades']['monedero'] ?? 0, 2) ?></td>
                    ...
                    <td class="text-right text-info"><?= '$' . number_format($ingresos_del_dia['mensualidades']['mercado_pago'] ?? 0, 2) ?></td>
                    <td class="text-right"><?= '$' . number_format($ingresos_del_dia['mensualidades']['total'] ?? 0, 2) ?></td>
                </tr>
                <tr>
                    <td>Horas</td>
                    <td class="text-right text-muted"><?= '$' . number_format($ingresos_del_dia['horas']['monedero'] ?? 0, 2) ?></td>
                    ...
                    <td class="text-right text-info"><?= '$' . number_format($ingresos_del_dia['horas']['mercado_pago'] ?? 0, 2) ?></td>
                    <td class="text-right"><?= '$' . number_format($ingresos_del_dia['horas']['total'] ?? 0, 2) ?></td>
                </tr>
                <tr>
                    <td>Visitas</td>
                    <td class="text-right text-muted"><?= '$' . number_format($ingresos_del_dia['visitas']['monedero'] ?? 0, 2) ?></td>
                    ...
                    <td class="text-right text-info"><?= '$' . number_format($ingresos_del_dia['visitas']['mercado_pago'] ?? 0, 2) ?></td>
                    <td class="text-right"><?= '$' . number_format($ingresos_del_dia['visitas']['total'] ?? 0, 2) ?></td>
                </tr>
                <tr>
                    <td>Artículos</td>
                    <td class="text-right text-muted"><?= '$' . number_format($ingresos_del_dia['articulos']['monedero'] ?? 0, 2) ?></td>
                    ...
                    <td class="text-right text-info"><?= '$' . number_format($ingresos_del_dia['articulos']['mercado_pago'] ?? 0, 2) ?></td>
                ...
                <tr>
                    ...
                    <td class="text-right text-info"><?= '$' . number_format($ingresos_del_dia['abonos']['mercado_pago'] ?? 0, 2) ?></td>
                ...
                <tr class="success text-bold">
                    ...
                    <td class="text-right text-muted"><?= '$' . number_format($totales['monedero_gastado'], 2) ?></td>
                    <td class="text-right"><?= '$' . number_format($totales['efectivo'], 2) ?></td>
                    <td class="text-right"><?= '$' . number_format($totales['tarjeta_total'], 2) ?></td>
                    <td class="text-right text-info"><?= '$' . number_format($totales['mercado_pago'], 2) ?></td>
    ...
    <div class="col-md-4">
        ...
        <div class="row h5">
            <div class="col-md-7 text-info">(-) Ingresos Digitales (MP):</div>
            <div class="col-md-5 text-right text-info">-$<?= number_format($totales['mercado_pago'], 2) ?></div>
        </div>
        <div class="row h5">
