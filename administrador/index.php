<?php
	...
	//aca por las peticiones y todas tengas la misma estructura
...
<html lang="es-MX">
	<head>
		...
		<title>Servicios Generales y de Mantenimiento | SERGYM</title>
		
		<link href="../css/bootstrap.css?20170915_3" rel="stylesheet">
				...
				<div class="container-fluid">
					...
					<div id="navbar" class="collapse navbar-collapse">
						<ul class="nav navbar-nav">
							<!--li><a href=".?s=configuracion"><span class="glyphicon glyphicon-cog"></span> Administración</a></li-->
						</ul>
			...
			<div class="container">
				<div class="row text-muted">
					<div class="col-md-12 text-center">
						<a href="http://sergym.com">http://sergym.com</a> | SERGYM &copy; <?= date('Y') ?> | Servicios Generales y de Mantenimiento | <?= date( 'd/m/Y h:i:s a' ) ?>
					</div>
				</div>
			</div>
		</footer>
		
		<div class="modal fade" id="modal_principal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">
