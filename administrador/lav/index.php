	...
	<head>
		...
		<?php
			...
			if( file_exists( "js/js.js" ) )
				echo "<script type='application/javascript' src='js/js.js$version_js'></script>";
			
			if( file_exists( "js/js_$seccion.js" ) )
				echo "<script type='application/javascript' src='js/js_$seccion.js$version_js'></script>";
			
			if( file_exists( "js/js_$seccion"."_$item.js" ) )
				echo "<script type='application/javascript' src='js/js_$seccion"."_$item.js$version_js'></script>";
		?>
	</head>
			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="."><span class="glyphicon glyphicon-home"></span> <?= $empresa_desc ?></a>
					</div>
