<?php
	...
	$lista_ventas		= lista_ventas_del_mes( $mes_evaluar );
	$importe_vent		= obtener_total_venta_efectivo( $mes_evaluar );
	$importe_gastos		= obtener_gastos( $mes_evaluar );
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<br/>
		<h3 class="text-info"><strong>Diferencia: $<?= $ganancia ?></strong></h3>
	</div>
</div>
