...
<div class="row">
    <div class="col-md-12">
        <p>Un ticket solo podrá ser CANCELADO cuando este con status de RECEPCIONADO, si se paso como Lavado o
            Entregado, ya no se podrá cancelar.</p>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <select name="busqueda" id="busqueda" class="form-control">
                ...
                <option <?= ( $busqueda == 'LS' ) ? 'selected':'' ?> value="LS">Inventario (Lavados y por planchar)
                </option>
