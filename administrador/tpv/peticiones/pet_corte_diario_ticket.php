<?php
	...
	$tipo_corte	= request_var( 'tipo_corte', 0 );
	$datos		= "";
...
<div class="modal-dialog modal-sm">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title text-primary">Corte de Caja.</h4>
		</div>
		...
		<div class="modal-footer">
			...
			<label id="btn_procesar">
				<button type="button" onclick="imprimir_ticket_corte_diario( <?= $id_corte.", ".$id_usuario.", ".$tipo_corte ?> )" class="btn btn-primary">Imprimir Ticket</button>
			</label>
		</div>
	</div>
</div>