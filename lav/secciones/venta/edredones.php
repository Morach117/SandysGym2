<div class="row">
	<div class="col-md-12">
		<h4 class="bg-info text-info">
			<span class="glyphicon glyphicon-usd"></span> PUNTO DE VENTA DE SERVICIOS DE EDREDONES
		</h4>
	</div>
</div>
...
<?php
	$datos		= obtener_servicios( 'EDREDONES' );
	$entrega	= fecha_entrega( 'EDREDONES' );
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="row text-info text-bold h4">
						...
						<label class="col-md-3" id="subtotal">$00.00</label>
					</div>
					
					<div class="row text-info text-bold h4">
						<label class="col-md-9 text-right">Descuento %</label>
						<label class="col-md-3" id="por_descuento">00.00%</label>
					</div>
					
					<div class="row text-info text-bold h4">
						<label class="col-md-9 text-right">Descuento $</label>
						<label class="col-md-3" id="mon_descuento">$00.00</label>
					</div>
					...
					<div class="row text-success text-bold h4">
						...
						<label class="col-md-3" id="total">$00.00</label>
					</div>
					...
					<div class="row">
						<div class="col-md-12 text-right">
							<input type="hidden" id="tipo" value="EDREDONES" />
