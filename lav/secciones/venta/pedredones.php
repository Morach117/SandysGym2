<div class="row">
	<div class="col-md-12">
		<h4 class="bg-info text-info">
			<span class="glyphicon glyphicon-usd"></span> PUNTO DE VENTA DE SERVICIOS DE EDREDONES - ADMIN
		</h4>
	</div>
</div>
...
<?php
	$datos		= obtener_servicios( 'EDREDONES', 'S' );
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12 text-right">
							<input type="hidden" id="tipo" value="PEDREDONES" />
