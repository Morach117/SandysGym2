<div class="row">
	<div class="col-md-12">
		<h4 class="bg-success text-info">
			<span class="glyphicon glyphicon-usd"></span> PUNTO DE VENTA DE SERVICIOS DE PLANCHADURIA
		</h4>
	</div>
</div>
...
<?php
	$datos		= obtener_servicios( 'PLANCHADURIA' );
	$entrega	= fecha_entrega( 'PLANCHADURIA' );
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12 text-right">
							<input type="hidden" id="tipo" value="PLANCHADURIA" />
