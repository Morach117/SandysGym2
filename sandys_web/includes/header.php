    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="canvas-menu mobile-menu">
            <ul>
                ...
                <?php if ($userName): ?>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" id="userDropdownMobile" role="button">
                            <i class="fa-solid fa-user"></i> <?php echo htmlspecialchars($userName); ?> </a>
                        <ul class="dropdown-menu" id="userMenuMobile">
                ...
                <?php else: ?>
                    <li><a href="index.php?page=login"><i class="fa-solid fa-user"></i> Iniciar Sesión</a></li> <?php endif; ?>
            </ul>
                ...
                <div class="col-lg-3">
                    <div class="top-option d-flex justify-content-end align-items-center">
                        ...
                        <div class="mr-3 d-none d-lg-block">
                            <?php if ($userName): ?>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" id="userMenu">
                                        <span class="dropdown-item-text"><?php echo htmlspecialchars($userName); ?></span> <div class="dropdown-divider"></div>
                            ...
                            <?php else: ?>
                                <a href="index.php?page=login"><i class="fa-solid fa-user"></i></a> <?php endif; ?>
                        </div>
                        <div>
