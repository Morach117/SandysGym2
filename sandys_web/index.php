...
$publicPages = [
    ...
    'login', 'registration', 'validate', 'reset_password', 'inscribite','success_stories'
    // 'gracias' y 'pago_fallido' movidas de aquí
];
$privatePages = [
    'user_home', 'user_information', 'user_rutina',
    'user_calculator', 'user_pago_membresia', 'routine',
    'gracias', 'pago_fallido','recibo', 'mis_pagos','user_admin_plan','user_referidos','user_monedero'// <-- AÑADIDAS AQUÍ
];
