                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="cd-trainer-pic">
                                    <img src="./assets/img/classes/class-details/trainer-profile.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="cd-trainer-text">
                                    <div class="trainer-title">
                                        <h4>Athart Rachel</h4>
                                        <span>Entrenador de Gimnasio</span>
                                    </div>
                                    ...
                                    <ul class="trainer-info">
                                        <li><span>Edad</span>35</li>
                                        <li><span>Peso</span>148lbs</li>
                                        <li><span>Altura</span>10' 2''</li>
                                        <li><span>Ocupación</span>no-founder</li>
                                    </ul>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                        tempor incididunt ut labore et dolore magna aliqua viverra maecenas lacus
                                        vel facilisis.</p>
                ...
                <div class="sidebar-option">
                    <div class="so-categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Correr <span>32</span></a></li>
                            <li><a href="#">Pérdida de peso <span>86</span></a></li>
                            <li><a href="#">Cardio <span>25</span></a></li>
                            <li><a href="#">Culturismo <span>36</span></a></li>
                            <li><a href="#">Nutrición <span>15</span></a></li>
                        </ul>
                    </div>
                    <div class="so-latest">
                        <h5 class="title">Últimas publicaciones</h5>
                        <div class="latest-large set-bg" data-setbg="./assets/img/letest-blog/latest-1.jpg">
                            <div class="ll-text">
                                <h5><a href="#">Este método japonés de hacer café helado es un juego...</a></h5>
                                <ul>
                                    <li>20 de agosto, 2019</li>
                        ...
                        <div class="latest-item">
                            ...
                            <div class="li-text">
                                <h6><a href="#">Ensalada de papa a la parrilla y judías verdes</a></h6>
                                <span class="li-time">15 de agosto, 2019</span>
                            </div>
                        </div>
                        <div class="latest-item">
                            <div class="li-pic">
                            ...
                            <div class="li-text">
                                <h6><a href="#">El rosado francés de $8 que compro en grandes cantidades cada verano</a></h6>
                                <span class="li-time">15 de agosto, 2019</span>
                            </div>
                        </div>
                        <div class="latest-item">
                            ...
                            <div class="li-text">
                                <h6><a href="#">Pollo asado al limón en sartén de Ina Garten</a></h6>
                                <span class="li-time">15 de agosto, 2019</span>
                            </div>
                        </div>
                        <div class="latest-item">
                            ...
                            <div class="li-text">
                                <h6><a href="#">Las mejores papas al horno para la noche entre semana, 3 maneras creativas</a></h6>
                                <span class="li-time">15 de agosto, 2019</span>
                            </div>
                        </div>
                    </div>
                    <div class="so-banner set-bg" data-setbg="./assets/img/sidebar-banner.jpg">
