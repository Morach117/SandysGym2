            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        <div class="hi-text">
                            <span>Moldea tu cuerpo</span>
                            <h1>Sé <strong>fuerte</strong> entrenando duro</h1>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="pricing-section spad">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-8">
                <div class="ps-item">
                    <h3>Individual Mensual</h3>
                    <div class="pi-price">
                        <h2>$ 400.0</h2>
                        <span>ESTUDIANTES: $ 380.0</span>
                    </div>
                    <ul>
                        <li>Área de pesas</li>
                        <li>Área de cardio</li>
            ...
            <div class="col-lg-4 col-md-8">
                <div class="ps-item">
                    <h3>Individual Ahorro</h3>
                    <div class="pi-price">
                        <h2>$ 750.0</h2>
                        <span>BIMESTRAL / $ 1050 TRIMESTRAL</span>
                    </div>
                    <ul>
                        <li>Área de pesas</li>
                        <li>Área de cardio</li>
