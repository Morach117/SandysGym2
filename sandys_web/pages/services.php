    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 order-lg-4 col-md-6 p-0">
                <div class="ss-text">
                    <h4>Clases de fitness en grupo</h4>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="bs-text service-banner">
                    <h2>Ejercítate hasta que el cuerpo obedezca.</h2>
